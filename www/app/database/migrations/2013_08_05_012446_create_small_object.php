...
class CreateSmallObject extends Migration {
	...
	{
				//use snake-casing
		Schema::create('smaller_example_objects', function($table)//name is plural of object we want to store
		{
	...
	{
		Schema::drop('smaller_example_objects');
	}
